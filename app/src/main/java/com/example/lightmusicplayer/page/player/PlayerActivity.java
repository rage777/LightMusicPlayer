...
//                    String s = passedL(progress);
//                    binding.now.setText(s);
//                }
//
//            }
//
...
//    public String passedL(long lSeconds) {
//        lSeconds /= 1000;
...
//    public void updateTimeNow(int now){
//        String s = passedL(now);
//        runOnUiThread(() -> binding.now.setText(s));
...
//            while (!isEnd){
//                if (!isPause){
//                    runOnUiThread(this::doInMainThread);
//                }
//                try {
//                    Thread.sleep(1000);
